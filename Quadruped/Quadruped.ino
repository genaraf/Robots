...
// --------        --------
//
// Wemos D1 Mini pins: 1-D4, 2-D2, 3-D0, 4-D1, 5-D5, 6-D6, 7-D8, 8-D7  (9-RX GPIO3 NeoPixel)  
//
...
// Firmware version
String FW_Version = "Q1 mini - Quadruped Robot v1.5 (Designed by Jason Workshop)";
...
NeoPixelBus<NeoGrbFeature, NeoEsp8266Dma800KbpsMethod> strip(2, 0);
...
void setup(void)
{
  ...
  String AP_NameString = "Q1 mini - " + macID;
...
void handleIndex()
{
  ...
  content += "</tr>";
  content += "<tr height=19%>";
  content += "<td><button type=button onclick=controlPm(4)>Left</button></td>";
  content += "<td><button type=button onclick=controlPm(3)>Backward</button></td>";
  content += "<td><button type=button onclick=controlPm(5)>Right</button></td>";
  content += "</tr>";
  ...
  content += "</tr>";
  content += "<tr height=19%>";
  content += "<td><button type=button style=background:#CFBFFF onclick=controlPm(13)>Dancing 1</button></td>";
  content += "<td><button type=button style=background:#CFBFFF onclick=controlPm(14)>Dancing 2</button></td>";
  content += "<td><button type=button style=background:#CFBFFF onclick=controlPm(15)>Dancing 3</button></td>";
  content += "</tr>";
  content += "</table>";
